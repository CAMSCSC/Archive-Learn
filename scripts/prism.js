/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+css-extras+clike+javascript+java+php+php-extras+bash+c+cpp+python+sql+ruby+csharp+swift+objectivec&plugins=line-highlight+line-numbers+file-highlight */
...
// Add HTML support of the markup language exists (WHY DON'T WE NOT SO I CAN ACTUALLY PUT PHP TAGS?????)
if (Prism.languages.markup_blahblahblah) { //too lazy to remove
